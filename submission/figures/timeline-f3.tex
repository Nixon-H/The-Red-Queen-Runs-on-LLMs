% figures/timeline-f3.tex — F3: capability timeline 2023–2026 (spec-required figure)
...
% Slash-separated labels denote discrete event months, not continuous intervals.
\foreach \x/\lab in {1.2/{2023-08},4.0/{2024-08},5.6/{2024-11},7.6/{2025-05/06},
                     9.4/{2025-07/08},11.6/{2025-09/11},13.4/{2026-02/05}} {
  \node[ev,below] at (\x,-0.12) {\lab}; \node[dot,gray] at (\x,0) {};}
% above-axis events
...
\node[mis] at (11.6,0.30) {};
\node[ev,anchor=south] at (11.6,0.55) {GTG-1002 campaign\\ (80--90\% autonomous)};
\node[ev,anchor=south] at (13.4,0.55) {R7 SoK; OpenSSF legacy\\ SIG + transition funding};
\node[gov] at (13.4,0.30) {};
% legend
\node[font=\tiny,anchor=west] at (0.2,-0.75)
