...
First-page screening caps per query, publisher-API absence, and English-language sources are
 ...
 repeated the classification procedure for all 14 autonomy-bearing records, with six boundary
...
\hline
\multicolumn{5}{l}{\scriptsize Totals: 14 autonomy-bearing ($A1{\times}2$, $A2{\times}11$, unresolved${\times}1$, $A3{=}0$)
...
\begin{center}
\captionof{table}{A3 sensitivity analysis. Each row relaxes one classification condition
while holding the others fixed; the rightmost column identifies the closest candidate and
the condition that still prevents A3 qualification.}
\label{tab:sensitivity}
\centering\scriptsize
\begin{tabular}{p{1.5cm}p{5.5cm}p{2.5cm}p{5cm}}
\hline
Scenario & Relaxation & A3 count & Closest candidate and remaining blocker \\
\hline
S0 & Baseline (strict four-verb test) & 0 & XBOW: human review before submission; AIxCC CRS: human-selected targets; GTG-1002: unresolved evidence \\
S1 & Human review relaxed & 0 & XBOW: still requires human security-team review; AIxCC CRS: human-selected targets \\
S2 & Target-selection autonomy relaxed & 0 & AIxCC CRS: human-selected targets; but B1 still requires human triage \\
S3 & Production-environment requirement relaxed & 0 & AIxCC CRS: benchmark settings; XBOW: mandated human review \\
S4 & All relaxations combined & 0 & GTG-1002: unresolved (insufficient public evidence for definitive assignment) \\
\hline
\end{tabular}
\end{center}
