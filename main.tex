...
evaluation validity as a measured constraint: information conditions change reported exploitation
...
documented limitations; none, we argue, plausibly reverses the central negative finding
 (Sec.~\ref{sec:conclusion}), which is robust to reasonable variations of the inclusion rule.
 ...
 classifications for all 20 records; disagreements were concentrated on environment-class
...
2024-11 & Big Sleep reports SQLite stack-buffer-underflow zero-day; cites AIxCC inspiration (edge D1); AFL 150 CPU-h fails to rediscover; no CVE assigned [bigsleep2024]\\
2024-11 & OSS-Fuzz reports 26 vulns from AI-generated fuzz targets incl.\ CVE-2024-9143 (${\sim}$20 years latent) [ossfuzz-levelingup-2024]\\
