...
evidence that agents can operate on realistic infrastructure; press-derived superiority
percentages are excluded from this paper because they do not appear in the primary text.
...
authors report that vulnerabilities were publicly disclosed before model training cutoffs.
...
\begin{center}
\captionof{table}{A3 sensitivity analysis. A3 requires independent planning, execution,
validation, and reporting in environment class E2 (Sec.~\ref{sec:framework}). The
\emph{no-human-interaction corollary} requires that reporting be fully autonomous; this
corollary is not relaxed in any scenario. Each row relaxes one condition while holding the
others fixed.}
\label{tab:sensitivity}
\centering\scriptsize
\begin{tabular}{p{1.3cm}p{4cm}p{1cm}p{2.2cm}p{5.5cm}}
\hline
Scenario & Condition relaxed & A3 & Closest candidate & Remaining blocker(s) \\
\hline
S0 & None (baseline) & 0 & XBOW & XBOW: human review before submission (reporting);
AIxCC CRS: human-selected targets (planning), E1 environment;
ARTEMIS: human professionals set scope (planning);
GTG-1002: insufficient evidence \\
S1 & Human review relaxed & 0 & XBOW & XBOW: reporting pipeline includes human review
(no-human-interaction corollary violated);
AIxCC CRS: human-selected targets, E1;
ARTEMIS: human professionals in planning and reporting \\
S2 & Target-selection autonomy relaxed & 0 & AIxCC CRS & AIxCC CRS: E1 environment;
XBOW: human review (corollary);
ARTEMIS: human professionals \\
S3 & E2 environment requirement relaxed & 0 & AIxCC CRS & AIxCC CRS: human-selected targets;
XBOW: human review (corollary);
ARTEMIS: human professionals \\
S4 & All combined & 0 & XBOW & XBOW: reporting pipeline requires human review
(no-human-interaction corollary);
ARTEMIS: human professionals in planning and reporting;
AIxCC CRS: E1 environment;
GTG-1002: unresolved \\
\hline
\end{tabular}
\end{center}
