...
independently re-coded the 14 autonomy-bearing records plus 6 boundary cases (GTG-1002,
XBOW, ARTEMIS, Big Sleep, Argusee, AIxCC cluster) using two additional coders blind to the
original labels. Raw agreement was 85\% (23/27 records); disagreements centered on
environment-class boundaries (E1 vs.\ E2) and the uncertain classification of GTG-1002.
All disagreements were resolved by applying the weakest-missing-condition rule
(Sec.~\ref{sec:framework}); no record's autonomy level changed after adjudication. We
report this as evidence that the taxonomy produces stable classifications, not as a formal
reliability coefficient; a larger-scale validation with domain-expert coders remains future
work. Additional methodological constraints include:
