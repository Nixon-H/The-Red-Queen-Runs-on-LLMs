...
sixteen-hour runs~\cite{artemis2025}. We use it as environment-class E2 evidence that
...
showing that LLM agents can systematically inspect large codebases and validate candidate bug
paths. These systems, together with the agent lineage above, establish that B3 capability now
spans from pipeline-orchestrated repair (Agentless) through iterative agentic workflows
(AutoCodeRover, CodeRover-S) to autonomous discovery-audit pipelines (RepoAudit), yet robust
...
AIxCC generated documented institutional follow-through---DARPA committed \$200K per finalist
team for transition activities, while the competition itself carried prize commitments reported
as \$29.5M in DARPA's 2024 materials and \$30.5M in OpenSSF's later retrospective; separately,
...
Date & Event (source) \\
\hline
2023-08 & AIxCC announced; ${\sim}\$29.5$M cumulative program commitment~\cite{darparesults2025} \\
...
\begin{center}
\captionof{table}{A3 sensitivity analysis.}
\label{tab:sensitivity}
\centering\scriptsize
\begin{tabular}{p{1.5cm}p{8cm}r}
\hline
Scenario & Relaxation & A3 count \\
\hline
S0 & Baseline (strict four-verb test) & 0 \\
S1 & Human review requirement relaxed & 0 \\
S2 & Target-selection autonomy relaxed & 0 \\
S3 & Production-environment requirement relaxed & 0 \\
S4 & All relaxations combined & 0 \\
\hline
\end{tabular}
\end{center}
