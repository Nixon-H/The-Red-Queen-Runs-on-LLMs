...
exclude the Agentless paper~\cite{agentless2024} from our comparison and analysis, as its
...
documented limitations; the A3-negative finding remains robust within the documented corpus under the sensitivity scenarios reported in Sec.~\ref{sec:conclusion}, but cannot exclude undocumented systems outside the observable evidence base.
 ...
 applied the classification protocol twice to the 14 autonomy-bearing records plus 6 boundary
 cases (GTG-1002, XBOW, ARTEMIS, Big Sleep, Argusee, AIxCC cluster), once during initial
 coding and once during a blind re-coding pass. The two passes yielded consistent
 classifications for all 20 records, although intermediate uncertainty was concentrated on environment-class
 boundaries (E1 vs.\ E2) and the uncertain classification of GTG-1002, which the
...
gathering failure information before committing patches~\cite{ossfuzz-aifixing-2024}. Reported efficacy
...
scoring, we found no included system with documented exploit-aware patch validation outside the competition artifacts;
...
\$29.5M in cumulative program prizes funded \$200K/team transition integration and university research,
while \$30.5M in competition distributions supported foundation governance; and
...
2025-08 & AFC finals: 48 challenges/23 repos; 143 h fully autonomous operation; 18 real vulns found; Atlanta \$4M / ToB \$3M / Theori \$1.5M; \$200K/team transition funding~\cite{darparesults2025,tobbuttercup2025,taafc2025,darpascoring2025}\\
2025-09..11 & Anthropic reports GTG-1002 campaign, 80--90\% autonomous execution~\cite{anthropicgtg2025,anthropicgtgreport2025}\\
2026-02..05 & R7 SoK camera-ready (USENIX Sec'26); OpenSSF legacy retrospective: CRS SIG, FuzzingBrain 62v/26proj, OSS-CRS 25v/16proj~\cite{r7sokaixcc2026,openssfaixcc2026}\\
\hline
\end{tabular}}
\end{center}
